...
//Armed Choppers (Huey)
DZMSChoppers = ["UH1H_Ori","Mi171ShCZ_Ori"];

//Small Vehicles (Humvees)
DZMSSmallVic = ["SUV_MG_Ori","ori_p85_originsmod_CUCV","HMMWV_Ori","ori_vil_originsmod_lublin_truck"];

//Large Vehicles (Urals)
DZMSLargeVic = ["ori_vil_truck_civ_base"];
