...
_bpackList = ["DZ_Patrol_Pack_EP1","origins_bear","DZ_ALICE_Pack_EP1","DZ_CivilBackpack_EP1","DZ_Backpack_EP1","O_TravelerPack_1","ori_30l_Backpack"];
_gshellList = ["HandGrenade_west","FlareGreen_M203","FlareWhite_M203"];
_medical = ["ItemBandage","ItemMorphine","ItemEpinephrine","ItemPainkiller","ItemWaterbottle","ItemAntibiotic","ItemBloodbag"];
_money = ["ItemBpt_h2","ItemBpt_b2","ItemCinderblocks","ItemRestTent","Partscrap"];
