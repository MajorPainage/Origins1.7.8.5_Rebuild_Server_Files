...
//Turrets
[[[(_position select 0) + 10, (_position select 1) + 10, 0],[(_position select 0) + 10, (_position select 1) - 10, 0]],"SectorMG_Ori",0.8,"Bandit2_1DZ",0,2,"","Random",true] call spawn_static;
