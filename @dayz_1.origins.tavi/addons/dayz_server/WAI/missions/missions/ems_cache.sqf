...
_vehclass = ["ori_p85_originsmod_cucv_pickup","ori_vil_originsmod_lublin_truck"] call BIS_fnc_selectRandom;
...
//ori_p85_originsmod_cucv_pickup/ori_vil_originsmod_lublin_truck
...
[[_position select 0, _position select 1, 0],_rndnum,1,"Random",6,"","Bandit2_1DZ","Random",true] call spawn_group;
     
[[_position select 0, _position select 1, 0],4,1,"Random",4,"","Bandit2_1DZ","Random",true] call spawn_group;

[[[(_position select 0), (_position select 1) + 30, 0],[(_position select 0) + 30, (_position select 1), 0]],"SectorMG_Ori",0.8,"Bandit2_1DZ",2,2,"","Random",true] call spawn_static;
