...
[[_position select 0, _position select 1, 0],_rndnum,1,"Random",4,"","Hero3_5DZ","Random",true] call spawn_group;
[[_position select 0, _position select 1, 0],5,1,"Random",4,"","Hero3_6DZ","Random",true] call spawn_group;
[[_position select 0, _position select 1, 0],5,1,"Random",4,"","Hero3_6DZ","Random",true] call spawn_group;
[[_position select 0, _position select 1, 0],5,1,"Random",4,"","Hero3_6DZ","Random",true] call spawn_group;
...
"Hero3_5DZ",				          //Skin "" for random or classname here.
...
"SectorMG_Ori",             //Classname of turret
0.7,					  //Skill level 0-1. Has no effect if using custom skills
"Hero3_6DZ",				          //Skin "" for random or classname here.
1,						  //Primary gun set number. "Random" for random weapon set. (not needed if ai_static_useweapon = False)
2,						  //Number of magazines. (not needed if ai_static_useweapon = False)
"",						  //Backpack "" for random or classname here. (not needed if ai_static_useweapon = False)
"Random",				  //Gearset number. "Random" for random gear set. (not needed if ai_static_useweapon = False)
...
//Heli Para Drop
[[(_position select 0),(_position select 1),0],[0,0,0],400,"HC3_Merlin_Ori",10,1,"Random",4,"","Hero3_6DZ","Random",False] spawn heli_para;
