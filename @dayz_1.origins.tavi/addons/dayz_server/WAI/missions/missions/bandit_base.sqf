...
[[_position select 0, _position select 1, 0],_rndnum,1,"Random",4,"","Bandit2_5DZ","Random",true] call spawn_group;
[[_position select 0, _position select 1, 0],4,1,"Random",4,"","Bandit2_5DZ","Random",true] call spawn_group;
[[_position select 0, _position select 1, 0],4,1,"Random",4,"","Bandit2_5DZ","Random",true] call spawn_group;
[[_position select 0, _position select 1, 0],4,1,"Random",4,"","Bandit2_5DZ","Random",true] call spawn_group;
[[_position select 0, _position select 1, 0],4,1,"Random",4,"","Bandit2_5DZ","Random",true] call spawn_group;
...
//Turrets
[[[(_position select 0) - 10, (_position select 1) + 10, 0]],"SectorMG_Ori",0.8,"Bandit2_5DZ",1,2,"","Random",true] call spawn_static;
[[[(_position select 0) + 10, (_position select 1) - 10, 0]],"SectorMG_Ori",0.8,"Bandit2_5DZ",1,2,"","Random",true] call spawn_static;
[[[(_position select 0) + 10, (_position select 1) + 10, 0]],"SectorMG_Ori",0.8,"Bandit2_5DZ",1,2,"","Random",true] call spawn_static;
[[[(_position select 0) - 10, (_position select 1) - 10, 0]],"SectorMG_Ori",0.8,"Bandit2_5DZ",1,2,"","Random",true] call spawn_static;

//Heli Paradrop
[[(_position select 0), (_position select 1), 0],[7743.41, 7040.93, 0],400,"UH1H_Ori",10,1,"Random",4,"","USMC_Soldier_Pilot","Random",True] spawn heli_para;
