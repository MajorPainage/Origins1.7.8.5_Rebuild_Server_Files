...
DELIMITER ;
-- ----------------------------
-- Procedure structure for `pCleanup3`
-- ----------------------------
DROP PROCEDURE IF EXISTS `pCleanup3`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pCleanup3`()
BEGIN
...
DELIMITER ;
-- ----------------------------
-- Procedure structure for `pCleanup4`
-- ----------------------------
DROP PROCEDURE IF EXISTS `pCleanup4`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pCleanup4`()
BEGIN
...
DELIMITER ;
-- ----------------------------
-- Procedure structure for `pCleanup5`
-- ----------------------------
DROP PROCEDURE IF EXISTS `pCleanup5`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pCleanup5`()
BEGIN
...
DELIMITER ;
-- ----------------------------
-- Procedure structure for `pCleanup6`
-- ----------------------------
DROP PROCEDURE IF EXISTS `pCleanup6`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pCleanup6`()
BEGIN
...
DECLARE iupdateCount	INT(3) DEFAULT 0;
	...
	IF iupdateCount = (6) THEN
		CALL pCleanup();
	END IF;
	IF iupdateCount = (5) THEN
		CALL pCleanup6();
	END IF;
	IF iupdateCount = (4) THEN
		CALL pCleanup5();
	END IF;
	IF iupdateCount = (3) THEN
		CALL pCleanup4();
	END IF;
	IF iupdateCount = (2) THEN
		CALL pCleanup3();
	END IF;
